...
function WorkCard({ p, i }) {
  ...
  return (
    <RevealFade as="div" className={`wp-card ${feature ? "is-feature" : ""}`} delay={(i % 2) * 100}>
      <a href={window.projectHref(p)} target={isExt ? "_blank" : undefined} rel={isExt ? "noopener noreferrer" : undefined} data-cursor="hover" data-cursor-label={isExt ? "Use Haya Ai" : "Read case"} data-screen-label={meta.display || p.title}>
